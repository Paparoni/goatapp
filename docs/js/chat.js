    ...
    function __decorate(a, b, c, d) {
        ...
        if ("object" === typeof f && "function" === typeof f.decorate) g = f.decorate(a, b, c, d);
            ...
            for (var k = a.length - 1; 0 <= k; k--)
                if (f = a[k]) g = (3 > e ? f(g) : 3 < e ? f(b, c, g) : f(b, c)) || g;
        ...
        return new N(function(b, c) {
            ...
            if (d)
                for (var g = function(a, c) {
                        ...
                        c(a)
                    }, k = 0, n; k < a.length; k++) n = a[k], ua(n, w(g, k), f);
            else b(e)
        })
    };
        ...
        var d = {},
            ...
            f = {
                ...
                initializeApp: function(a, c) {
                    void 0 === c ? c = "[DEFAULT]" : "string" === typeof c && "" !== c || Y("bad-app-name", {
                        name: c + ""
                    });
                    void 0 !== d[c] && Y("dupApp", {
                        name: c
...
(function() {
    ...
    Nb.prototype.preventDefault = function() {
        ...
        else if (a.returnValue = !1, Kb) try {
    ...
    */
    ...
    var be = "StopIteration" in l ? l.StopIteration : {
    ...
    var Mf = function(a) {
        ...
        return {
            postBody: ef(b).toString(),
            requestUri: vf() ? hf() : "http://localhost"
        }
    };
    ...
    Sf.credential = function(a, b) {
        ...
        return new Lf("google.com", !1, ga(a) ? a : {
            idToken: a || null,
            accessToken: b || null
        })
    };
    ...
    var Yf = {
        ...
        Zf = function(a) {
            ...
            a = a && a.oauthIdToken;
            for (var e in Yf)
                if (Yf[e].PROVIDER_ID == b) try {
                    return Yf[e].credential({
                        accessToken: c,
                        idToken: a,
                        oauthToken: c,
                        oauthTokenSecret: d
    ...
    var Nh = function(a, b, c, d, e, f) {
        ...
        Ph = function(a, b, c, d, e) {
            ...
            return a.Tb.l(function() {}).then(function() {
                return of(d)
            }).then(function() {
    ...
    h.linkWithPopup = function(a) {
        ...
        var f = nf(e, c && c.tb, c && c.sb),
            c = qi(this, a.providerId).then(function() {
                return di(b)
            }).then(function() {
                ri(b);
                return b.getToken()
    ...
    h.linkWithRedirect = function(a) {
        ...
        var b = this,
            c = null,
            d = this.Fb(),
            e = qi(this, a.providerId).then(function() {
                ri(b);
                return b.getToken()
            }).then(function() {
                b.Xb = d;
...
(function() {
            ...
            if (!c.Bb) {
                c.Wa = new Se(function(a, b, d, k, m) {
                    ...
                    if (c.Wa)
                        ...
                        else if ("close" === a) b ? (c.Wa.Kd = !1, Sb(c.ff, b, function() {
                        c.fb()
                    })) : c.fb();
    ...
    function lf(a) {
        ...
        }), a.Xc = a.D, gf(a)) : (a.f("sending ping on secondary."), a.D.send({
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function kf(a) {
        a.Cb || 1 !== a.L || (a.f("sending ping on primary."), mf(a, {
            t: "c",
            d: {
                t: "p",
                d: {}
    ...
    function Bg(a, b, c) {
        ...
        var d = J(b);
        a = a.children.get(d);
        return null !== a ? (b = Bg(a, D(b), c), null != b ? {
            path: (new L(d)).m(b.path),
            value: b.value
        } : null) : null
    }
    ...
    h.re = function(a, b, c) {
        this.ma ? vh(this, "o", a, b, c) : this.Lc.push({
            we: a,
            action: "o",
            data: b,
            G: c
    ...
    h.gf = function(a, b, c) {
        this.ma ? vh(this, "om", a, b, c) : this.Lc.push({
            we: a,
            action: "om",
            data: b,
            G: c
    ...
    h.xd = function(a, b) {
        this.ma ? vh(this, "oc", a, null, b) : this.Lc.push({
            we: a,
            action: "oc",
            data: null,
            G: b
...
(function() {
    ...
    var Yb = "StopIteration" in m ? m.StopIteration : {
            message: "StopIteration",
            stack: ""
        },
        Zb = function() {};
